...
const BADGES = [
  ...
  { id: 'fifty_workouts', name: 'Regular Fixture', description: 'Complete 50 workouts', category: 'Consistency', tier: 'bronze', metric: 'workouts_total', threshold: 50 },
  ...
  { id: 'bench_1_plate', name: 'One Plate Bench', description: `Bench press ${plates(1)} kg — a plate a side`, category: 'Clubs', tier: 'bronze', metric: 'bench_kg', threshold: plates(1), unit: 'kg' },
  ...
  { id: 'cardio_10k', name: '10K', description: 'Cover 10 km in a single session', category: 'Cardio', tier: 'bronze', metric: 'cardio_best_session_km', threshold: 10, unit: 'km' },
  ...
  { id: 'local_legend', name: 'Local Legend', description: 'Reach 10 followers', category: 'Social', tier: 'bronze', metric: 'followers', threshold: 10 },
  ...
  { id: 'macro_tracker', name: 'Macro Tracker', description: 'Log your food on 30 different days', category: 'Tracking', tier: 'bronze', metric: 'nutrition_days', threshold: 30 },
